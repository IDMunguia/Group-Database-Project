...
public static class MemberUI
{
    ...
    public static void Show(Member person)
    {
        ...
        table.AddColumns("", "");
        table.HideHeaders();
        table.AddRow("[blue]Birthday[/]", person.Birthday.ToString("MM/dd/yyyy"));
    ...
    public static void Edit(Database database, Member member)
    {
        ...
        member.GiftIdea = AnsiConsole.Ask<string>("Enter the gift idea for the member: ");
    ...
    public static Member Create(Database database)
    {
        return new Member
        {
            ...
            GiftIdea = Questions.AskString("Enter the gift idea for the member: ", false)!
        };
